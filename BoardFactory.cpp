...
Board* BoardFactory::createBoard1() { //top right bot left
	...
	Boat boats[4];
	boats[0] = Boat(&board[2][1], Boat::Orientation::RIGHT, &board[2][2], Boat::Orientation::LEFT, Boat::Color::RED);
...
Board* BoardFactory::createBoard2() { //top right bot left
	...
	Boat boats[4];
	boats[0] = Boat(&board[2][0], Boat::Orientation::RIGHT, &board[2][1], Boat::Orientation::LEFT, Boat::Color::GREEN);
	return new Board(board, boats, 1);
}
...
Board* BoardFactory::createBoard6() { //top right bot left
	...
	Boat boats[4];
	boats[0] = Boat(&board[0][0], Boat::Orientation::LEFT, NULL, Boat::Orientation::LEFT, Boat::Color::GREEN);
	boats[1] = Boat(&board[0][0], Boat::Orientation::RIGHT, &board[0][1], Boat::Orientation::LEFT, Boat::Color::RED);
